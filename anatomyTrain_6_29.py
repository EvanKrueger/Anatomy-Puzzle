...
#	slicePlane.color(viz.ORANGE)
	...
	device = init_walk_around_6_28.pointerInput(config.pointerMode, pointer, sky)
	### Initialize display
	model.display = init_walk_around_6_28.DisplayInstance(config.dispMode,config.camMode,device,pointer)
