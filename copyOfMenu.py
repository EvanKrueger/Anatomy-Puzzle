### Changes I want to make to config ###
...
class DisplayMode:
	...
	fullscreen	= 3
	splitscreen = 4
	label		= {'monitor': 0, 'tv': 1, 'oculus': 2, 'fullscreen': 3, 'splitscreen':4}
...
menuScaleConfig = { \
	...
	4:{'main': 0.5, 'mode': 1.0, 'layer': 0.30, 'ingame': 1.0, 'test': 1.0, 'loading':1.0}} # Alison: Added
